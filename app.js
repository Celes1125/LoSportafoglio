...
app.use(cors({
  origin: ['http://localhost:4200', 'http://localhost:4200/dashboard/reports/movementsTable', 'https://my-wallet-six-kohl.vercel.app/', 'http://localhost:41489'], // Permitir el origen de tu frontend
