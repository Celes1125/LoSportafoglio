...
app.use(cors({
  origin: ['http://localhost:4200', 'http://localhost:4200/dashboard/reports/movementsTable', 'https://lo-sportafoglio-front.vercel.app', 'http://localhost:41489'], // Permitir el origen de tu frontend
